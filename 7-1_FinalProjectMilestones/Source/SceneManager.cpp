...
void SceneManager::LoadSceneTextures()
{
	...
	*/
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/circular-bryshed-gold-texture.jpg",
		"cylinder_top");
	...
	*/
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/forest.jpg",
		"forest");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/deck.jpg",
		"deck");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/titania.jpg",
		"titania");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/nl.jpg",
		"nl");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/cobra.jpg",
		"cobra");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/burgeoning.jpg",
		"burgeoning");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/d6.png",
		"d6");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 10.0f, 20.0f, -10.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.11f, 0.11f, 0.11f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 10.0f, 20.0f, 0.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 10.0f, 20.0f, 0.0f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 2.0f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 2.5f, 5.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.25f, 2.5f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.75f, 1.0f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 1.0f, 2.75f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.625f, 4.875f, 4.625f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.625f, 3.4375f, 4.625f);
	...
	/*** PLAYMAT ***/
	scaleXYZ = glm::vec3(4.0f, 0.05f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 3.2f, 2.0f);
	...
	/*** CARD1 ***/
	scaleXYZ = glm::vec3(0.2f, 1.0f, 0.3f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.0f, 3.25f, 1.75f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.625f, 3.25f, 2.125f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.25f, 3.25f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.125f, 3.2f, -0.1875f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.25f, 3.25f, 0.875f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.625f, 3.25f, 1.625f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.5f, 3.25f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.125f, 3.325f, 2.875f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.25f, 3.325f, 2.75f);
	...
	/*** DECK ***/
	scaleXYZ = glm::vec3(0.4f, 0.4f, 0.6f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.75f, 3.375f, 0.375f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.25f, 3.5f, -0.375f);
	...
	// set the transformatrions into memory to be used on the drawn meshes
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
